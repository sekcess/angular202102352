...
export class CuacaComponent implements OnInit, AfterViewInit {
        ...
        [
          {
            ...
            "render" : function (data: string)
            {
              ...
              var html = waktu.local().format("YYYY-MM-DD") + "<br /r>" + waktu.local().format("HH:mm") + " WIB";
              return html;
            }
          },
          {
  ...
  bind_table1() : void {
    this.http.get("http://api.openweathermap.org/data/2.5/forecast?id=1630789&appid=9cd7e2123ae8cbc2fa526fbcde6373eb")
    .subscribe((data: any) => {
      console.log(data);
